...
----------------------------------------------------------------------------
Usage:
    - python export_yoloV8_cls.py --weights yolov8s-cls.pt -s 224 224 --opset 12 --simplify --dynamic
...
def parse_args():
    parser = argparse.ArgumentParser(description='DeepStream YOLOv8 Classification model conversion')
